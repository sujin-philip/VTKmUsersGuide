...
\vtkmmacro{VTKM\_SUPPRESS\_EXEC\_WARNINGS}, to be used before any
\textcode{template} keyword, to tell the compiler to ignore the
inconsistency when resolving the template.
