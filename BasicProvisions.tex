...
For example, \VTKm contains \textidentifier{Vec}-like objects that essentially behave the same but might have different features such as a variable number of components.
