...
After the \textcode{find\_package} function completes, the following CMake variables are defined, which are then used for subsequent configuration.
...
\item[\cmakevtkmpackagevariable{VTKm\_COMPILE\_OPTIONS}]
  ...
  Targets should use the \textcode{target\_compile\_options} CMake function to add this list of directories to the compile commands.
\end{description}
