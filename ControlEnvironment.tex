...
used to load an array whose type is not known until runtime.
...
\emph{before} andy VTK-m headers are included. If included after a VTK-m
...
methods names \textcode{ResetTypeList} and
...
\vtkmlisting{Specifying both component types and contianer types in a \textidentifier{DynamicArrayHandle}.}{CastAndCallTypeAndContainer.cxx}
