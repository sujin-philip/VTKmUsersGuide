...
\fix{Change the template parameters below to be array handle types instead
of storage types. This is problematic for checking the value types, but
should run into less problems with special array handles. See
ArrayHandleGroupVec.}
...
\fix{Should also include a constructor that takes a base array handle of the
appropriate storage.}

\fix{Also need to add a VTK\_CONT\_EXPORT}

\fix{Also should make StorageTag and ValueType public.}
...
\fix{This is a work in progress!}
