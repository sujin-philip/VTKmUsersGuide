...
\fix{Example: Using \textidentifier{CellShapeIdToTag}.}
...
\fix{Example: Using \protect\vtkmmacro{vtkmGenericCellShapeMacro} to
  implement a function overloaded on cell shape. Alternatively, just point
  to the traits example.}
...
\fix{Example: Using \textidentifier{CellTraits} to implement a polygon
  normal estimator.}
