...
\lstdefinelanguage{VTKm}{
  ...
  morekeywords={[2]Id,Id2,Id3,IdComponent,Vec,
                   ...
                   make_Id3,make_Vec,
                   dot,NUM_COMPONENTS,
                   VecC,VecCConst,make_VecC,
                   VecFromPortal,VecFromPortalPermute,
                   ...
                   IsSizeStatic,VecTraitsTagSizeStatic,VecTraitsTagSizeVariable,
                   ...
                   ArrayHandleGroupVecVariable,make_ArrayHandleGroupVecVariable,
                   ...
                   TypeCheckTagCellSet,TypeCheckTagKeys,
                   Transport,
                   TransportTagArrayIn,TransportTagArrayOut,
                   TransportTagArrayInOut,
                   TransportTagExecObject,
                   TransportTagWholeArrayIn,TransportTagWholeArrayOut,
                   TransportTagWholeArrayInOut,
                   TransportTagAtomicArray,
                   TransportTagCellSetIn,TransportTagTopologyFieldIn,
                   TransportTagKeysIn,
                   TransportTagKeyedValuesIn,TransportTagKeyedValuesOut,
                   TransportTagKeyedValuesInOut,
                   TransportTagReducedValuesIn,
                   Fetch,
                   FetchTagArrayDirectIn,FetchTagArrayDirectOut,
                   FetchTagExecObject,
                   FetchtagCellSetIn,FetchTagArrayTopologyMapIn,
                   AspectTagDefault,
                   AspectTagWorkIndex,AspectTagOutputIndex,
                   AspectTagVisitIndex,
                   AspectTagCellShape,
                   AspectTagFromCount,AspectTagFromIndices,
                   AspectTagValueCount,
                   ControlSignatureTagBase,ExecutionSignatureTagBase,
                   Invocation,
                   ...
                   CellInterpolate,
                   CellDerivative,
                   CellEdgeNumberOfEdges,CellEdgeLocalIndices,
                   CellFaceNumberOfFaces,CellFaceNumberOfPoints,
                   CellFaceLocalIndices,
                   TransferToOpenGL,
  ...
  morekeywords={[3]VTKM_CONT,VTKM_EXEC,VTKM_EXEC_CONT,
                   VTKM_EXEC_CONSTANT,
                   ...
                   VTKM_ASSERT,VTKM_STATIC_ASSERT,
...
\newcommand{\vtkmcontmodifier}{\vtkmmacro{VTKM\_CONT}\index{modifier!control}\index{function modifier}\index{method modifier}\xspace}
\newcommand{\vtkmexecmodifier}{\vtkmmacro{VTKM\_EXEC}\index{modifier!execution}\index{function modifier}\index{method modifier}\xspace}
\newcommand{\vtkmexeccontmodifier}{\vtkmmacro{VTKM\_EXEC\_CONT}\index{modifier!control}\index{modifier!execution}\index{function modifier}\index{method modifier}\xspace}
...
\newcommand*{\vtkmworkletinternal}[1]{%
  \ifthenelse{\equal{#1}{}}%
             {\writenamespacethree{vtkm}{worklet}{internal}\indexnamespacetwo{vtkm}{worklet}{internal}}%
             {\writeindexidentifierthree{vtkm}{worklet}{internal}{#1}}}
\newcommand*{\vtkmio}[1]{%
  \ifthenelse{\equal{#1}{}}%
...
% This is an ``odd'' identifier that comes up a lot.
\newcommand*{\Veclike}{\textidentifier{Vec}-like\xspace}

% Used for source code, shell, CMake, or other examples that are not worth
% creating a ``language'' for.
\lstnewenvironment{blankexample}[2][-*-]{
  \lstset{language={}}
  \lstset{caption={#2}}
  \ifthenelse{\equal{#1}{-*-}}{}{\lstset{label=#1}}
}{
