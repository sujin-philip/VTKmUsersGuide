...
\index{surface normals|(}
\index{normals|(}

\vtkmfilter{SurfaceNormals} computes the surface normals of a polygonal data
...
overriden using the \textcode{SetCellNormalsName} and
\textcode{SetPointNormalsName} methods.

In addition to the standard field filters methods,
\textidentifier{SurfaceNormals} provides the following methods.

\begin{description}
\item[\textcode{SetGenerateCellNormals}/\textcode{GetGenerateCellNormals}]
  These methods can be used to set/get the flag to specify if the cell normals
  should be generated.
\item[\textcode{SetGeneratePointNormals}/\textcode{GetGeneratePointNormals}]
  These methods can be used to set/get the flag to specify if the point normals
  should be generated.
\item[\textcode{SetCellNormalsName}/\textcode{GetCellNormalsName}]
  These methods can be used to set/get the output cell normals field name.
\item[\textcode{SetPointNormalsName}/\textcode{GetPointNormalsName}]
