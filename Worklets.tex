...
\fix{Write the documentation to go along with the example.}

\fix{Should implement \textcode{GetCellDimensions} in
  \textidentifier{CellSetStructured} and updated this example.}
